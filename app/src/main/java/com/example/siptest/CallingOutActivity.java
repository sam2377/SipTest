...
//            }
        ...
        try {
            MainActivity.sipData.sipAudioCall = MainActivity.sipData.sipManager.makeAudioCall(MainActivity.sipData.sipProfile.getUriString(), MainActivity.sipData.peer.getUriString(), listener, 30 );
        }catch (Exception e){
            Log.d("SIP",e.getMessage());
        }
